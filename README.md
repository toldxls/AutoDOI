...
Turn a DOI into a reference, find a DOI from a title or a pasted reference, and convert reference lists to any style, EndNote or RIS. Metadata comes live from [Crossref](https://api.crossref.org) with a fallback to doi.org content negotiation (covers DataCite DOIs such as Zenodo and Figshare).
